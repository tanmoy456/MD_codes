module parameters
    ...
    integer, parameter  :: save_time = 1000 !after 100 steps save data
    ...
    integer, parameter  :: ncycle = 1000000 !Total Monte Carlo steps
    real*8, parameter   :: del_max = 1.5 !delx 
...
program mc
    ...
    call LJ_energy
    print*,' Final Potential Energy(from LJ)  : ',PE/n_part
    print*,' The no. of accepted moves : ',counter
    print*,' The acceptance ratio      : ',counter/float(ncycle)
    close(11)
    close(22)
    close(33)
